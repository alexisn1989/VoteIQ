#!/usr/bin/env python3
"""
trigger_hampton_agenda.py

Called by the Render cron job "voteiq-hampton-agenda".
POSTs to /api/admin/ingest-hampton-agenda on the running web service so the
...
url = f"{SERVICE_URL}/api/admin/ingest-hampton-agenda"
print(f"POST {url}")
