#!/usr/bin/env python3
"""
trigger_portsmouth_agenda.py

Called by the Render cron job "voteiq-portsmouth-agenda".
POSTs to /api/admin/ingest-portsmouth-agenda on the running web service so the
...
url = f"{SERVICE_URL}/api/admin/ingest-portsmouth-agenda"
print(f"POST {url}")
