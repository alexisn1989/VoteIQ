#!/usr/bin/env python3
"""
trigger_chesapeake_votes.py

Called by the Render cron job "voteiq-chesapeake-votes".
POSTs to /api/admin/ingest-chesapeake-votes on the running web service so the
...
url = f"{SERVICE_URL}/api/admin/ingest-chesapeake-votes"
print(f"POST {url}")
