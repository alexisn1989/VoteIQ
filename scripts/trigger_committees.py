#!/usr/bin/env python3
"""
trigger_committees.py

Called by the Render cron job "voteiq-committees-weekly".
GETs /api/admin/ingest-committees on the running web service so the ingest runs inside the
...
url = f"{SERVICE_URL}/api/admin/ingest-committees"
print(f"GET {url}")
