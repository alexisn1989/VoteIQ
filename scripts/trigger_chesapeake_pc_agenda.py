#!/usr/bin/env python3
"""
trigger_chesapeake_pc_agenda.py

Called by the Render cron job "voteiq-chesapeake-pc-agenda".
POSTs to /api/admin/ingest-chesapeake-pc-agenda on the running web service so
...
url = f"{SERVICE_URL}/api/admin/ingest-chesapeake-pc-agenda"
print(f"POST {url}")
