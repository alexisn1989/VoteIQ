#!/usr/bin/env python3
"""
trigger_portsmouth_votes.py

Called by the Render cron job "voteiq-portsmouth-votes".
POSTs to /api/admin/ingest-portsmouth-votes on the running web service so the
...
url = f"{SERVICE_URL}/api/admin/ingest-portsmouth-votes"
print(f"POST {url}")
