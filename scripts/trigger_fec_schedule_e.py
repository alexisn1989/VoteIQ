#!/usr/bin/env python3
"""
trigger_fec_schedule_e.py

Called by the Render cron job "voteiq-schedule-e-weekly".
POSTs /api/admin/ingest-fec-schedule-e on the running web service so the ingest runs inside the
...
url = f"{SERVICE_URL}/api/admin/ingest-fec-schedule-e"
print(f"POST {url}")
