#!/usr/bin/env python3
"""
trigger_vb_pc_agenda.py

Called by the Render cron job "voteiq-vb-pc-agenda".
POSTs to /api/admin/ingest-vb-pc-agenda on the running web service so the
...
url = f"{SERVICE_URL}/api/admin/ingest-vb-pc-agenda"
print(f"POST {url}")
