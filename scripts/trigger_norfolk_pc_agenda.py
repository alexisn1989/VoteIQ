#!/usr/bin/env python3
"""
trigger_norfolk_pc_agenda.py

Called by the Render cron job "voteiq-norfolk-pc-agenda".
POSTs to /api/admin/ingest-norfolk-pc-agenda on the running web service so
...
url = f"{SERVICE_URL}/api/admin/ingest-norfolk-pc-agenda"
print(f"POST {url}")
