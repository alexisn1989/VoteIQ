#!/usr/bin/env python3
"""
trigger_suffolk_pc_agenda.py

Called by the Render cron job "voteiq-suffolk-pc-agenda".
POSTs to /api/admin/ingest-suffolk-pc-agenda on the running web service so
...
url = f"{SERVICE_URL}/api/admin/ingest-suffolk-pc-agenda"
print(f"POST {url}")
