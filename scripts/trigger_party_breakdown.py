#!/usr/bin/env python3
"""
trigger_party_breakdown.py

Called by the Render cron job "voteiq-party-breakdown-monthly".
POSTs /api/admin/ingest-party-breakdown on the running web service so the ingest runs inside the
...
url = f"{SERVICE_URL}/api/admin/ingest-party-breakdown"
print(f"POST {url}")
