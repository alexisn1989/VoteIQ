#!/usr/bin/env python3
"""
trigger_chesapeake_agenda.py

Called by the Render cron job "voteiq-chesapeake-agenda".
POSTs to /api/admin/ingest-chesapeake-agenda on the running web service so the
...
url = f"{SERVICE_URL}/api/admin/ingest-chesapeake-agenda"
print(f"POST {url}")
