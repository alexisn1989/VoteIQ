#!/usr/bin/env python3
"""
trigger_suffolk_votes.py

Called by the Render cron job "voteiq-suffolk-votes".
POSTs to /api/admin/ingest-suffolk-votes on the running web service so the
...
url = f"{SERVICE_URL}/api/admin/ingest-suffolk-votes"
print(f"POST {url}")
