#!/usr/bin/env python3
"""
trigger_newport_news_agenda.py

Called by the Render cron job "voteiq-newport-news-agenda".
POSTs to /api/admin/ingest-newport-news-agenda on the running web service so the
...
url = f"{SERVICE_URL}/api/admin/ingest-newport-news-agenda"
print(f"POST {url}")
