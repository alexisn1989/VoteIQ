#!/usr/bin/env python3
"""
trigger_hampton_votes.py

Called by the Render cron job "voteiq-hampton-votes".
POSTs to /api/admin/ingest-hampton-votes on the running web service so the
...
url = f"{SERVICE_URL}/api/admin/ingest-hampton-votes"
print(f"POST {url}")
