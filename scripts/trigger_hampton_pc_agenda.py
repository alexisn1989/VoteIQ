#!/usr/bin/env python3
"""
trigger_hampton_pc_agenda.py

Called by the Render cron job "voteiq-hampton-pc-agenda".
POSTs to /api/admin/ingest-hampton-pc-agenda on the running web service so
...
url = f"{SERVICE_URL}/api/admin/ingest-hampton-pc-agenda"
print(f"POST {url}")
