#!/usr/bin/env python3
"""
trigger_vb_agenda.py

Called by the Render cron job "voteiq-vb-agenda".
POSTs to /api/admin/ingest-vb-agenda on the running web service so the
...
url = f"{SERVICE_URL}/api/admin/ingest-vb-agenda?days={DAYS}"
print(f"POST {url}")
