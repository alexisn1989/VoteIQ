#!/usr/bin/env python3
"""
trigger_portsmouth_pc_agenda.py

Called by the Render cron job "voteiq-portsmouth-pc-agenda".
POSTs to /api/admin/ingest-portsmouth-pc-agenda on the running web service so
...
url = f"{SERVICE_URL}/api/admin/ingest-portsmouth-pc-agenda"
print(f"POST {url}")
