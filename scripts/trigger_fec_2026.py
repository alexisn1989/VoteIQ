...
Called by the Render cron job "voteiq-fec-2026-monthly".
POSTs /api/admin/ingest-fec-2026 on the running web service so the ingest runs inside the
...
url = f"{SERVICE_URL}/api/admin/ingest-fec-2026"
print(f"POST {url}")
