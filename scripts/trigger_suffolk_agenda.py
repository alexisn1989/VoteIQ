#!/usr/bin/env python3
"""
trigger_suffolk_agenda.py

Called by the Render cron job "voteiq-suffolk-agenda".
POSTs to /api/admin/ingest-suffolk-agenda on the running web service so the
...
url = f"{SERVICE_URL}/api/admin/ingest-suffolk-agenda"
print(f"POST {url}")
