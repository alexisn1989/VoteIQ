...
def lookup(address: str):
    ...
    return {
        ...
        "chesapeake": {
            "mayor":                  (lambda m: {"name": m["name"], "party": m.get("party", "")} if m else None)(_chesapeake_officials.get("mayor")),
            "vice_mayor":             (lambda m: {"name": m["name"], "party": m.get("party", "")} if m else None)(_chesapeake_officials.get("vice_mayor")),
            "sheriff":                (lambda m: {"name": m["name"], "party": m.get("party", "")} if m else None)(_chesapeake_officials.get("sheriff")),
            "commonwealths_attorney": (lambda m: {"name": m["name"], "party": m.get("party", "")} if m else None)(_chesapeake_officials.get("commonwealths_attorney")),
            "commissioner":           (lambda m: {"name": m["name"], "party": m.get("party", "")} if m else None)(_chesapeake_officials.get("commissioner")),
        ...
        "portsmouth": {
            ...
            "school_board": [{"name": m["name"], "party": m.get("party", "")} for m in _portsmouth_officials.get("school_board", [])],
        ...
        "hampton": {
            ...
            "commonwealths_attorney": (lambda m: {"name": m["name"], "party": m.get("party", "")} if m else None)(_hampton_officials.get("commonwealths_attorney")),
            "commissioner":           (lambda m: {"name": m["name"], "party": m.get("party", "")} if m else None)(_hampton_officials.get("commissioner")),
            "treasurer":              (lambda m: {"name": m["name"], "party": m.get("party", "")} if m else None)(_hampton_officials.get("treasurer")),
            "clerk":                  (lambda m: {"name": m["name"], "party": m.get("party", "")} if m else None)(_hampton_officials.get("clerk")),
        ...
        "newport_news": {
            "mayor":                  (lambda m: {"name": m["name"], "party": m.get("party", "")} if m else None)(_newport_news_officials.get("mayor")),
            "vice_mayor":             (lambda m: {"name": m["name"], "party": m.get("party", "")} if m else None)(_newport_news_officials.get("vice_mayor")),
            "sheriff":                (lambda m: {"name": m["name"], "party": m.get("party", "")} if m else None)(_newport_news_officials.get("sheriff")),
            "commonwealths_attorney": (lambda m: {"name": m["name"], "party": m.get("party", "")} if m else None)(_newport_news_officials.get("commonwealths_attorney")),
